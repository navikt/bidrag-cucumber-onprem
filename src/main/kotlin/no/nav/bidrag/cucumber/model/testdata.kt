...
internal class TestData {
  ...
  fun harIkkeLagretTestdata(nokkel: String) =
    dataForNokkel[nokkel]?.journalpostId == null || dataForNokkel[nokkel]?.joarkJournalpostId == null

  fun hentJournalpostId(nokkel: String?) =
    dataForNokkel[nokkel]?.journalpostId ?: throwIllegalStateException("Ingen testdata på $nokkel!")
  fun hentJoarkJournalpostId(nokkel: String?) =
    dataForNokkel[nokkel]?.joarkJournalpostId ?: throwIllegalStateException("Ingen testdata på $nokkel!")
  fun hentJournalpostIdUtenPrefix(nokkel: String?) = hentJournalpostId(nokkel).split("-")[1]
  fun hentSaksnummer(nokkel: String) =
    dataForNokkel[nokkel]?.saksnummer ?: throwIllegalStateException("Ingen testdata på $nokkel!")
...
const val fnr1 = "22496818540"
const val fnr2 = "31477719212"
const val fnr3 = "31528318552"
